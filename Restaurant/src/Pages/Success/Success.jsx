      ...
      <div className="container">
        <div className="success-popup">
          ...
          <div className="reservation-info">
            <p>
              <strong>Mã bàn của quý khách là:  </strong> <b style={{color:'red'}}>{reservationDetails.table}</b>
            </p>
            <p>
            ...
            <p>
              <strong>Thời gian giữ bàn của quý khách là:  </strong> {reservationDetails.holdTime}{" "}
              phút
            </p>
          </div>
